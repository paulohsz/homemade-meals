...
const Menu = () => {
  ...
  const { menuProps } = useWebsitePage();
  const [menuActive, setMenuActive] = useState<string | boolean>(false);
  const [menuSm, setMenuSm] = useState<boolean>(false);
